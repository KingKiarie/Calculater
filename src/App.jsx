...
function App() {
  ...
  return (
    ...
    <div className='w-2/6  mx-8 w-fit h-screen flex flex-wrap justify-center items-center bg-cyan-700'>
      <div>
        <div className="w-5/6  flex justify-center align-center h-5/6 bg-gray-800">
          <div className='flex w-4/6 h-3/6 text-white justify-end pr-10 text-3x1 mt-4'>
            {num}
          </div>
        </div>
        <div className="w-4/6  flex flex-wrap items-center justify-center text-white space-x-0.5  ">
